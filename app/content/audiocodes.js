export default {
	...
	html: `
		...
		<img src='/images/project_pics/audio_1.jpg' />
		<img src='/images/project_pics/audio_2.jpg' />
		<img src='/images/project_pics/audio_3.jpg' />
		<p>Two simple audioCode demos are shown below. One that brings up actor information, ... </p>
		<video src="/images/project_pics/audio_actors.mp4" controls preload="metadata"></video>
		<p>... and one that translates public announcements.</p>
		<video src="/images/project_pics/audio_translation.mp4" controls preload="metadata"></video>
	`,
};
